...
def make_input_box(main_dir, screen_scale, screen_rect, image_list):
    ...
    input_ui = uimenu.InputUI(screen_scale, input_ui_image,
                            (screen_rect.width / 2, screen_rect.height / 2))  # user text input ui box popup
    input_ok_button = uimenu.MenuButton(screen_scale, image_list,
    ...
    input_close_button = uimenu.MenuButton(screen_scale, image_list,
    ...
    confirm_ui = uimenu.InputUI(screen_scale, input_ui_image,
