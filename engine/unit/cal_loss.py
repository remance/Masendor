...
def cal_loss(self, final_dmg, impact, final_morale_dmg, element_effect, hit_angle):
    """
    :param self: Damage receiver Unit object
    ...
    impact_check = impact - self.base_body_mass
    ...
    if impact_check > self.max_health50:  # knockdown
        ...
        self.momentum = 0
        self.forced_target = Vector2(self.base_pos[0] - (impact_check / 5 * sin(radians(hit_angle))),
                                     self.base_pos[1] - (impact_check / 5 * cos(radians(hit_angle))))
