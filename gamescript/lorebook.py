...
class Lorebook(pygame.sprite.Sprite):
    ...
    def change_ruleset(self):
        ...
        self.equipment_stat = {}
        run = 1
        for stat_list in (self.troop_data.troop_weapon_list, self.troop_data.mount_weapon_list,
        ...
        self.equipment_lore = {}
        run = 1
        for stat_list in (self.troop_data.troop_weapon_lore, self.troop_data.mount_weapon_lore,
