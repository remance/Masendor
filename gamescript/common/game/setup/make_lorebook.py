...
def make_lorebook(main_dir, ruleset_folder, screen_scale, screen_rect):
    ...
    encyclopedia = lorebook.Lorebook(main_dir, screen_scale, screen_rect, encyclopedia_images["encyclopedia"])  # encyclopedia sprite
    ...
    lore_button_ui[1].change_pos((encyclopedia.rect.topleft[0] + (lore_button_images["concept"].get_width() * 1.1) * 1.5,
                                  encyclopedia.rect.topleft[1] - (lore_button_images["concept"].get_height() / 2)))
    lore_button_ui[2].change_pos((encyclopedia.rect.topleft[0] + (lore_button_images["concept"].get_width() * 1.1) * 2.5,
                                  encyclopedia.rect.topleft[1] - (lore_button_images["concept"].get_height() / 2)))
    lore_button_ui[3].change_pos((encyclopedia.rect.topleft[0] + (lore_button_images["concept"].get_width() * 1.1) * 3.5,
                                  encyclopedia.rect.topleft[1] - (lore_button_images["concept"].get_height() / 2)))
    lore_button_ui[4].change_pos((encyclopedia.rect.topleft[0] + (lore_button_images["concept"].get_width() * 1.1) * 4.5,
                                  encyclopedia.rect.topleft[1] - (lore_button_images["concept"].get_height() / 2)))
    lore_button_ui[5].change_pos((encyclopedia.rect.topleft[0] + (lore_button_images["concept"].get_width() * 1.1) * 5.5,
                                  encyclopedia.rect.topleft[1] - (lore_button_images["concept"].get_height() / 2)))
    lore_button_ui[6].change_pos((encyclopedia.rect.topleft[0] + (lore_button_images["concept"].get_width() * 1.1) * 6.5,
                                  encyclopedia.rect.topleft[1] - (lore_button_images["concept"].get_height() / 2)))
    lore_button_ui[7].change_pos((encyclopedia.rect.topleft[0] + (lore_button_images["concept"].get_width() * 1.1) * 7.5,
                                  encyclopedia.rect.topleft[1] - (lore_button_images["concept"].get_height() / 2)))
    lore_button_ui[8].change_pos((encyclopedia.rect.topleft[0] + (lore_button_images["concept"].get_width() * 1.1) * 8.5,
                                  encyclopedia.rect.topleft[1] - (lore_button_images["concept"].get_height() / 2)))
    lore_button_ui[9].change_pos((encyclopedia.rect.topleft[0] + (lore_button_images["concept"].get_width() * 1.1) * 9.5,
                                  encyclopedia.rect.topleft[1] - (lore_button_images["concept"].get_height() / 2)))
    lore_button_ui[10].change_pos((encyclopedia.rect.topleft[0] + (lore_button_images["concept"].get_width() * 1.1) * 10.5,
                                   encyclopedia.rect.topleft[1] - (lore_button_images["concept"].get_height() / 2)))
    lore_button_ui[11].change_pos((encyclopedia.rect.topleft[0] + (lore_button_images["concept"].get_width() * 1.1) * 11.5,
                                   encyclopedia.rect.topleft[1] - (lore_button_images["concept"].get_height() / 2)))
