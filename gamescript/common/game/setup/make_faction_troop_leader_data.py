...
def make_faction_troop_leader_data(main_dir, screen_scale, ruleset_folder, language):
    ...
    portrait_images = load_images(main_dir, screen_scale=screen_scale,
                                  subfolder=("ruleset", ruleset_folder, "leader", "preset", "portrait"))
    leader_data = datastat.LeaderData(main_dir, portrait_images, troop_data, ruleset_folder, language)
