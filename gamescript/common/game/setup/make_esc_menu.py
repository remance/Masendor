...
def make_esc_menu(main_dir, screen_rect, screen_scale, mixer_volume):
    ...
    esc_option_menu_button = [
        menu.EscButton(button_image, (menu_rect_center0 - button_image["0"].get_width() * 1.5, menu_rect_center1 * 1.3), text="Confirm", size=14),
        menu.EscButton(button_image, (menu_rect_center0, menu_rect_center1 * 1.3), text="Apply", size=13),
        menu.EscButton(button_image, (menu_rect_center0 + button_image["0"].get_width() * 1.5, menu_rect_center1 * 1.3), text="Cancel", size=14)]
    ...
    esc_value_box = [menu.ValueBox(esc_menu_images["value"], (battle_menu.rect.topright[0] * 1.08, menu_rect_center1), mixer_volume)]
