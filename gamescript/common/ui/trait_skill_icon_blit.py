...
def trait_skill_icon_blit(self):
    ...
    for trait in self.troop_card_ui.value2["trait"]:
        self.skill_icon.add(
            battleui.SkillCardIcon(self.trait_images["0"], (position[0], position[1]), "trait",
    ...
    for skill in self.troop_card_ui.value2["skill"]:
        self.skill_icon.add(
            battleui.SkillCardIcon(self.skill_images["0"], (position[0], position[1]), "skill",
